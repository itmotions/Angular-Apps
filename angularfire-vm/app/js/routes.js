...
angular.module('myApp.routes', ['ngRoute', 'ngAnimate', 'simpleLogin'])
  ...
  .constant('ROUTES', {
    ...
    '/bezoekers': {
      templateUrl: 'partials/bezoekers.html',
      controller: 'AboutCtrl'
    },
      
    '/verkopers': {
      templateUrl: 'partials/verkopers.html',
      controller: 'AboutCtrl'
    },  
      
    '/producten': {
      templateUrl: 'partials/producten.html',
      controller: 'MenuCtrl'
    },
